...
interface WorkflowTemplateContextSetter {
  key: string
  context: Awaited<ReturnType<typeof prepareTemplateStageLaunch>>["templateContext"]
}
...
export function useFactoryWorkflowActions({
  ...
  setWorkflowEntryState: (value: Awaited<ReturnType<typeof prepareTemplateStageLaunch>>["entryState"]) => void
  setInputValue: (value: string) => void
  setInputAttachments: (value: Awaited<ReturnType<typeof prepareTemplateStageLaunch>>["artifactAttachments"]) => void
  ...
  setWorkflowTemplateContextForKey: (value: WorkflowTemplateContextSetter) => void
}) {
