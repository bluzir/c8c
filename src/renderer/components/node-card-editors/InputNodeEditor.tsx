...
export function InputNodeEditor({
  ...
  return (
    <div className={EDITOR_PANEL_CLASS}>
      ...
      <div className={EDITOR_TOGGLE_ROW_CLASS}>
        ...
        <Switch
          ...
          onCheckedChange={(checked) =>
            onConfigChange({ ...config, required: checked })
          }
      ...
      {config.required === false && (
        <div>
          ...
          <TextareaWithMention
            ...
            onChange={(event) =>
              onConfigChange({ ...config, defaultValue: event.target.value })
            }
            rows={3}
      ...
      <div>
        <Label
          htmlFor={`input-placeholder-${nodeId}`}
          className="ui-meta-text text-muted-foreground mb-1 block"
        >
          Placeholder
        </Label>
