...
const buttonVariants = cva(
  "ui-pressable ui-focus-managed inline-flex appearance-none items-center justify-center whitespace-nowrap rounded-md text-body-sm font-medium transition-[background-color,border-color,color,transform,opacity] ui-motion-fast focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/14 disabled:opacity-100 disabled:[-webkit-text-fill-color:currentColor] [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "border border-primary/90 bg-primary !text-primary-foreground [-webkit-text-fill-color:hsl(var(--primary-foreground))] hover:bg-primary/90 hover:border-primary active:bg-primary/82 active:border-primary/85 active:!text-primary-foreground active:[-webkit-text-fill-color:hsl(var(--primary-foreground))] disabled:bg-primary/70 disabled:border-primary/70 disabled:!text-primary-foreground disabled:[-webkit-text-fill-color:hsl(var(--primary-foreground))]",
        destructive:
          "border border-destructive/80 bg-destructive !text-destructive-foreground [-webkit-text-fill-color:hsl(var(--destructive-foreground))] hover:bg-destructive/90 active:bg-destructive/82 active:border-destructive/85 active:!text-destructive-foreground active:[-webkit-text-fill-color:hsl(var(--destructive-foreground))] disabled:bg-destructive/70 disabled:border-destructive/70 disabled:!text-destructive-foreground disabled:[-webkit-text-fill-color:hsl(var(--destructive-foreground))]",
        send: "border border-transparent bg-foreground text-background hover:bg-foreground/90 active:bg-foreground/85 disabled:bg-surface-3 disabled:text-muted-foreground/70",
        outline:
          "border border-border bg-surface-1 text-foreground hover:bg-surface-2 hover:border-hairline active:bg-surface-3 active:text-foreground active:border-hairline disabled:border-border/80 disabled:bg-surface-2/80 disabled:text-disabled",
        secondary:
          "border border-border bg-surface-2 text-secondary-foreground hover:bg-surface-3 active:bg-surface-3/95 active:text-secondary-foreground active:border-border disabled:border-border/70 disabled:bg-surface-3/80 disabled:text-disabled",
        ghost:
