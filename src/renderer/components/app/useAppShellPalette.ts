...
type WorkflowExecutionStates = Parameters<typeof buildAppShellWorkflowEntries>[0]["workflowExecutionStates"]
type DesktopMenuState = Parameters<typeof buildDesktopCommandEntries>[0]
type OutputSurfaceCommandState = Parameters<typeof buildOutputSurfaceActionEntries>[0]
...
export function useAppShellPalette({
  ...
  setWorkflowCreateContext: (value: { projectPath: string | null; locked: boolean }) => void
