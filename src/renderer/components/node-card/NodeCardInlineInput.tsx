...
export function NodeCardInlineInput({ nodeId, inputConfig }: { nodeId: string; inputConfig: InputNodeConfig }) {
  ...
  return (
    <div className="border-t border-hairline bg-surface-1/80 px-2.5 py-2 space-y-1.5">
      ...
      {showInlineInputError && (
        <p id={`run-input-error-${nodeId}`} className="text-label-xs text-status-danger">
