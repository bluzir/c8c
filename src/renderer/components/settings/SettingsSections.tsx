...
export function statusBadgeClassName(
  ...
  return "ui-status-badge border-border text-muted-foreground"
}
...
interface SettingsChapterShellProps {
  title: string
  description?: string
  children: ReactNode
}

export function SettingsChapterShell({
  title,
  description,
  children,
}: SettingsChapterShellProps) {
  return (
  ...
  return (
    <section className="space-y-3">
      ...
      <article className="space-y-3 ui-section-divider">
        <div className={SETTINGS_SECTION_SLAB_CLASS}>
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
            ...
            <div className="space-y-1">
              ...
              <div className="ui-progress-track">
                <div
                  ...
                  style={{
                    transform: `scaleX(${(updateInfo.progress ?? 0) / 100})`,
                  }}
                />
              </div>
            </div>
          ...
          {updateInfo.status === "downloaded" ? (
            <p className="text-body-sm text-status-success">
              Version {updateInfo.version} is ready to install. Restart the app
              to apply the update.
            </p>
          ) : null}
...
export function SettingsExecutionDefaultsSection({
  ...
  return (
    <section className="space-y-3">
      <SectionHeading title="Run Defaults" />

      <article className="space-y-3 ui-section-divider">
        <div>
          <h3 className="text-body-md font-semibold">New flow defaults</h3>
          <p className="mt-1 text-body-sm text-muted-foreground">
            Default values applied when creating new flows. These do not affect
            existing saved flows.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <ProviderModelInput
                ...
                onValueChange={(value) =>
                  setExecDefaults((prev) => ({ ...prev, model: value }))
                }
            ...
            <div className="space-y-1.5">
              <Label
                htmlFor="exec-default-max-turns"
                className="text-body-sm font-medium text-foreground"
              >
                Max Turns
              </Label>
            ...
            <div className="space-y-1.5">
              <Label
                htmlFor="exec-default-max-parallel"
                className="text-body-sm font-medium text-foreground"
              >
                Max Parallel
              </Label>
        ...
        <div className={SETTINGS_SECTION_SLAB_CLASS}>
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-body-sm text-muted-foreground">
                Shows the advanced lab workspace and related navigation. Leave
                this off for the simpler flow editor and library view.
              </p>
            </div>
            <Switch
...
export function SettingsResearchSection({
  webSearchBackend,
  onValueChange,
}: SettingsResearchSectionProps) {
  return (
    <section className="space-y-3">
      ...
      <article className="space-y-3 ui-section-divider">
        <div className={SETTINGS_SECTION_SLAB_CLASS}>
          <div>
            ...
            <p className="mt-1 text-body-sm text-muted-foreground">
              Defines which web-search path is preferred when using library
              flows from the
          ...
          <Select
            ...
            onValueChange={(value) => onValueChange(value as "builtin" | "exa")}
          >
          ...
          <p className="ui-meta-text text-muted-foreground">
            Current setting is stored locally for this app profile and does not
            modify existing flow files.
          </p>
        </div>
      </article>
    </section>
...
export function SettingsProvidersSection({
  ...
  return (
    <section id="settings-providers" className="space-y-3">
      <SectionHeading title="Providers" />

      <article className="space-y-4 ui-section-divider">
        <div className="ui-slab grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="space-y-1.5">
            <Label
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(value) =>
                void onPersistProviderSettings({
                  safetyProfile: value as typeof providerSettings.safetyProfile,
                })
              }
            >
        ...
        <div className="space-y-0">
          {providers.map((providerId, index) => {
            ...
            const isDefaultProvider = defaultProvider === providerId
            const providerVerdict = resolveProviderReadinessVerdict(
              providerId,
              health,
              auth,
            )
            ...
            return (
              <div
                key={providerId}
                className={cn(
                  "space-y-4 -mx-3 rounded-xl px-3 py-5",
                  index > 0 && "border-t border-hairline",
                  isDefaultProvider && "ui-selected-row-tint",
                )}
              >
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-body-sm text-muted-foreground">
                      {health?.version ||
                        (available
                          ? "CLI version unknown"
                          : `Install: ${getProviderInstallCommand(providerId)}`)}
                    </p>
                  </div>
                  <span
                    className={cn(
                      statusBadgeClassName(providerVerdict.badgeVariant),
                      "ui-meta-text",
                    )}
                  >
                ...
                {available && !authenticated ? (
                  <p className="text-body-sm text-muted-foreground">
                    ...
                    {providerId === "codex"
                      ? " or save a CODEX_API_KEY override below."
                      : "."}
                  </p>
                ) : null}
                ...
                {providerId === "codex" ? (
                  <div className="ui-inset-well space-y-2">
                    <Label
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                      <Input
                        ...
                        onChange={(event) =>
                          onCodexApiKeyDraftChange(event.target.value)
                        }
        ...
        <div className={SETTINGS_SECTION_SLAB_CLASS}>
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-body-sm text-muted-foreground">
                Sends anonymized runtime metrics to improve reliability and
                update safety. No prompts, content, paths, or secrets are sent.
              </p>
            </div>
            <div className="flex items-center gap-2">
              {telemetryStatusBadge}
