...
describe("sanitizeMarkdownHref", () => {
  it("allows safe external and relative links", () => {
    ...
    expect(sanitizeMarkdownHref("/Users/vlad/Code/projects/chain-runner/README.md")).toBe("/Users/vlad/Code/projects/chain-runner/README.md")
    expect(sanitizeMarkdownHref("./references/guide.md")).toBe("./references/guide.md")
  })
